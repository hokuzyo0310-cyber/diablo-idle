...
func _update_class_label() -> void:
	var cls_name: String = "未选择"
	match GameManager.character_class:
		"barbarian": cls_name = "野蛮人 Barbarian"
		"sorceress": cls_name = "法师 Sorceress"
		"necromancer": cls_name = "死灵法师 Necromancer"
	class_label.text = cls_name + "  Lv.%d" % GameManager.level
